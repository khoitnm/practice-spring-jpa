...
import org.tnmk.practicespringjpa.pro00mssql03manydata.testinfra.BaseSpringTest_WithActual_MySql;
...
@Disabled
@Slf4j
public class SampleJdbcRepository_BatchInsert_Test extends BaseSpringTest_WithActual_MsSqlServer {
  @Autowired
