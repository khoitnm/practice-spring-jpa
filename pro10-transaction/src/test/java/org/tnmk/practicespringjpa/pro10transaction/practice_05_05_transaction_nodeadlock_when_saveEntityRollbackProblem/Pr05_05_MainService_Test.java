...
public class Pr05_05_MainService_Test extends BaseSpringTest_WithActualDb {
  ...
  @Test
  public void test_editFirstAndThenInsertDuplicateValueLater__butThen_InsertSuccessWhileEditingFailed()
    ...
    try {
      ...
      Assertions.assertTrue(ex.getCause() instanceof DataAccessException, "The actual ex cause is " + ex.getCause());
      ...
      Assertions.assertEquals(entityInExternalSystem.get().getName(), entityInDB.get().getName());
