package org.tnmk.practicespringjpa.pro10transaction.practice_03_03_parallelstream__privatemethod_hastnx;
...
@Slf4j
@Service
public class Pr03_03_MainService_ParallelStreamWithPrivateMethod_WithCatch {

  private final SimpleRepository simpleRepository;
  private final TransactionTemplate transactionTemplate;

  public Pr03_03_MainService_ParallelStreamWithPrivateMethod_WithCatch(
    ...
    parallelEntityNames.stream()
        ...
        .forEach(entityName -> {
          try {
            ...
            log.info("Item {}: get error: {}", entityName, ex.getMessage(), ex);
          }
        });
